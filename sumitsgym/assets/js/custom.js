...
function highlightBMICategory(bmi) {
    let categories = ["underweight", "healthy", "overweight", "obese"];
    ...
    if (bmi < 18.5) {
        document.getElementById("underweight").style.backgroundColor = "#ffcccc";
    } else if (bmi >= 18.5 && bmi <= 24.9) {
        document.getElementById("healthy").style.backgroundColor = "#ccffcc";
    } else if (bmi >= 25.0 && bmi <= 29.9) {
        document.getElementById("overweight").style.backgroundColor = "#ffeb99";
    } else {
        document.getElementById("obese").style.backgroundColor = "#ff6666";
    }
}